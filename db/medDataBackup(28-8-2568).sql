...
COPY public.med_delivery (delivery_id, patient_id, delivery_date, delivery_method, receiver_name, receiver_phone, address, note, status, medicine_list, doctor_id, created_at) FROM stdin;
...
COPY public.med_requests (request_id, med_id, quantity, unit, requested_by, approved_by, status, request_time, approved_time, dispensed_time, note, created_at, updated_at, is_approve, origin, med_sid, is_added) FROM stdin;
...
302	1	14	2025-08-27 20:50:31.088005	2025-08-27 20:50:31	\N	Take 1 tablet with breakfast	ไม่ระบุ	ไม่ระบุ	Active	\N	2025-08-27 20:50:31.088005	2025-08-27 20:50:31.088005
\.
...
COPY public.patient (patient_id, national_id, first_name, last_name, gender, birthday, age_y, age_m, age_d, blood_group, "PMH", phone, height, weight, bmi, patient_addr_id, hn_number, allergy_id, first_name_eng, last_name_eng, photo) FROM stdin;
...
SELECT pg_catalog.setval('public.adr_registry_adr_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.error_medication_err_med_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.expired_medicines_expired_med_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.med_delivery_delivery_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.med_order_history_history_id_seq', 102, true);
...
SELECT pg_catalog.setval('public.med_requests_request_id_seq', 76, true);
...
SELECT pg_catalog.setval('public.med_stock_history_history_id_seq', 222, true);
...
SELECT pg_catalog.setval('public.med_subwarehouse_med_sid_seq', 286, true);
...
SELECT pg_catalog.setval('public.med_usage_usage_id_seq', 302, true);
...
SELECT pg_catalog.setval('public.notification_log_log_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.overdue_med_overdue_id_seq', 37, true);
