...
(
    ...
    template_title text COLLATE pg_catalog."default",
    template_message text COLLATE pg_catalog."default",
    recipient_role_id integer,
    check_frequency_minutes integer,
    is_active boolean,
    last_checked_at timestamp with time zone DEFAULT now(),
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT noti_rules_pkey1 PRIMARY KEY (rule_id)
);

CREATE TABLE IF NOT EXISTS public.noti_rules_old
(
    rule_id integer NOT NULL DEFAULT nextval('noti_rules_rule_id_seq'::regclass),
    rule_name character varying(100) COLLATE pg_catalog."default" NOT NULL,
    rule_type character varying(50) COLLATE pg_catalog."default" NOT NULL,
    related_table character varying(100) COLLATE pg_catalog."default" NOT NULL,
...
ALTER TABLE IF EXISTS public.med_requests
    ADD CONSTRAINT med_requests_med_id_fkey FOREIGN KEY (med_id)
    REFERENCES public.med_table (med_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.noti_rules_old
    ADD CONSTRAINT fk_noti_rules_role FOREIGN KEY (recipient_role_id)
...
ALTER TABLE IF EXISTS public.notification_log
    ...
    REFERENCES public.noti_rules_old (rule_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
