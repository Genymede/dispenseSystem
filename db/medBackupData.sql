...
CREATE TYPE public.serivity_type AS ENUM (
    'mild',
    'moderate',
    'severe'
);
...
ALTER TYPE public.serivity_type OWNER TO postgres;
...
CREATE TABLE public.allergy_registry (
    ...
    description text,
    severity public.serivity_type DEFAULT 'mild'::public.serivity_type NOT NULL,
...
CREATE TABLE public.expired_medicines (
...
ALTER TABLE public.expired_medicines OWNER TO postgres;

--
-- Name: expired_medicines_expired_med_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.expired_medicines_expired_med_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.expired_medicines_expired_med_id_seq OWNER TO postgres;

--
-- Name: expired_medicines_expired_med_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.expired_medicines_expired_med_id_seq OWNED BY public.expired_medicines.expired_med_id;
...
CREATE TABLE public.med_subwarehouse (
    med_sid integer NOT NULL,
    med_id integer NOT NULL,
...
ALTER TABLE public.med_subwarehouse OWNER TO postgres;

--
-- Name: med_subwarehouse_med_sid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.med_subwarehouse_med_sid_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.med_subwarehouse_med_sid_seq OWNER TO postgres;

--
-- Name: med_subwarehouse_med_sid_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.med_subwarehouse_med_sid_seq OWNED BY public.med_subwarehouse.med_sid;
...
CREATE TABLE public.noti_rules (
...
ALTER TABLE public.noti_rules OWNER TO postgres;

--
-- Name: noti_rules_rule_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.noti_rules_rule_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.noti_rules_rule_id_seq OWNER TO postgres;

--
-- Name: noti_rules_rule_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.noti_rules_rule_id_seq OWNED BY public.noti_rules.rule_id;
...
ALTER SEQUENCE public.notification_log_log_id_seq OWNER TO postgres;
...
ALTER TABLE ONLY public.expired_medicines ALTER COLUMN expired_med_id SET DEFAULT nextval('public.expired_medicines_expired_med_id_seq'::regclass);
...
ALTER TABLE ONLY public.med_subwarehouse ALTER COLUMN med_sid SET DEFAULT nextval('public.med_subwarehouse_med_sid_seq'::regclass);
...
ALTER TABLE ONLY public.noti_rules ALTER COLUMN rule_id SET DEFAULT nextval('public.noti_rules_rule_id_seq'::regclass);
...
COPY public.adr_registry (adr_id, med_id, patient_id, description, reported_at, severity, outcome, reporter_id, notes, symptoms) FROM stdin;
...
COPY public.allergy_registry (allr_id, med_id, patient_id, symptoms, description, severity, reported_at, created_at, updated_at) FROM stdin;
...
COPY public.error_medication (err_med_id, "time", patient_id, doctor_id, med_id, description, resolved, created_at, updated_at, med_sid) FROM stdin;
...
15	2025-08-21 04:40:40.921	1	0	14	ะะะ	f	2025-08-21 11:40:59.346202	2025-08-21 11:40:59.346202	256
16	2025-08-21 05:20:30.569	1	0	14	ืืื	f	2025-08-21 12:20:33.653081	2025-08-21 12:20:33.653081	256
17	2025-08-22 15:55:50.649	1	10	30	คว*	f	2025-08-22 22:55:56.181639	2025-08-22 22:55:56.181639	285
18	2025-08-25 14:18:20.206	4	10	11	จ่ายยาผิดตัว	f	2025-08-25 21:18:41.320766	2025-08-25 21:18:41.320766	251
\.
...
COPY public.expired_medicines (expired_med_id, med_sid, med_id, status, moved_at) FROM stdin;
...
21	21	8	0	0	2	t	2025-08-17 21:17:22.376727	2025-08-17 23:19:33.730355
16	10	6	9	10	1	t	2025-06-13 14:38:34.509613	2025-08-19 00:13:20.64922
\.
...
COPY public.med_delivery (delivery_id, patient_id, delivery_date, delivery_method, receiver_name, receiver_phone, address, note, status, medicine_list, doctor_id) FROM stdin;
30	5	2025-08-24 18:06:33.541366	จัดส่งถึงบ้าน	ปกรณ์ รุ่งเรือง	0834455667	88 หมู่ 1 ถนนรังสิต-นครนายก, ตำบลคลองหลวง, อำเภอคลองหลวง, จังหวัดปทุมธานี 12120		pending	[{"med_id": 29, "med_sid": 283, "quantity": 1}, {"med_id": 10, "med_sid": 250, "quantity": 1}]	10
26	10	2025-08-09 11:01:16.817003	รับที่โรงพยาบาล	วราภรณ์ เพียรดี	0889900112	35/7 หมู่ 4 ถนนกาญจนบุรี-ไทรโยค, ตำบลท่าม่วง, อำเภอท่าม่วง, จังหวัดกาญจนบุรี 71110		delivering	[{"med_id": 1, "quantity": 1}, {"med_id": 2, "quantity": 3}]	10
27	15	2025-08-23 20:59:51.299467	รับที่โรงพยาบาล	อนุชา สืบสกุล	0956789012	89 หมู่ 2 ถนนกาญจนวนิช, ตำบลหาดใหญ่, อำเภอหาดใหญ่, จังหวัดสงขลา 90110	ddd	delivered	[{"med_id": 22, "med_sid": 269, "quantity": 1}, {"med_id": 1, "med_sid": 230, "quantity": 1}, {"med_id": 2, "med_sid": 232, "quantity": 1}]	10
29	6	2025-08-24 18:06:00.443105	จัดส่งด่วน	ชลธิชา สมสุข	0845566778	56/9 หมู่ null ถนนบรมราชชนนี, ตำบลศาลายา, อำเภอพุทธมณฑล, จังหวัดนครปฐม 73170		pending	[{"med_id": 23, "med_sid": 270, "quantity": 4}]	10
\.
...
COPY public.med_order_history (history_id, "time", patient_id, description, medicines, doctor_id, dispense_doc_id) FROM stdin;
...
COPY public.med_requests (request_id, med_id, quantity, unit, requested_by, approved_by, status, request_time, approved_time, dispensed_time, note, created_at, updated_at, is_approve, origin, med_sid) FROM stdin;
68	29	1	หลอด	8	\N	pending	2025-08-21 09:47:07.147214	\N	\N		2025-08-21 09:47:07.147214	2025-08-21 09:47:07.147214	f	subwareshouse	283
67	29	5	หลอด	8	\N	dispensed	2025-08-21 09:47:01.114441	\N	\N		2025-08-21 09:47:01.114441	2025-08-21 09:47:01.114441	t	subwareshouse	284
66	30	5	หลอด	8	\N	dispensed	2025-08-21 09:46:53.45246	\N	\N		2025-08-21 09:46:53.45246	2025-08-21 09:46:53.45246	t	subwareshouse	285
65	30	1000	หลอด	8	\N	dispensed	2025-08-21 09:44:24.655446	\N	\N		2025-08-21 09:44:24.655446	2025-08-21 09:44:24.655446	t	subwareshouse	285
69	1	11	หลอด	8	\N	dispensed	2025-08-21 17:25:23.694001	\N	\N		2025-08-21 17:25:23.694001	2025-08-21 17:25:23.694001	t	subwareshouse	231
60	29	1	หลอด	8	\N	dispensed	2025-08-21 07:37:17.22579	\N	\N	ใ	2025-08-21 07:37:17.22579	2025-08-21 07:37:17.22579	t	subwareshouse	284
59	30	1	หลอด	8	\N	dispensed	2025-08-21 07:35:42.067501	\N	\N	อ	2025-08-21 07:35:42.067501	2025-08-21 07:35:42.067501	t	subwareshouse	285
24	9	2	ขวด	8	8	dispensed	2025-06-19 18:26:35.633172	2025-06-20 18:26:35.633172	2025-06-21 18:26:35.633172	จ่ายแล้ว	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
28	6	3	หลอด	8	8	dispensed	2025-06-17 18:26:35.633172	2025-06-18 18:26:35.633172	2025-06-19 18:26:35.633172		2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
30	13	4	กล่อง	8	8	dispensed	2025-06-21 18:26:35.633172	2025-06-22 18:26:35.633172	2025-06-23 18:26:35.633172		2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
21	14	10	เม็ด	8	8	dispensed	2025-06-23 18:26:35.633172	\N	\N	รออนุมัติ	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
22	2	5	แคปซูล	8	8	dispensed	2025-06-21 18:26:35.633172	2025-06-22 18:26:35.633172	\N	อนุมัติแล้ว	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
23	25	20	เม็ด	8	8	dispensed	2025-06-20 18:26:35.633172	2025-06-21 18:26:35.633172	\N	ไม่ผ่านเกณฑ์	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
25	27	8	กล่อง	8	8	dispensed	2025-06-23 18:26:35.633172	\N	\N		2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
26	18	12	แคปซูล	8	8	dispensed	2025-06-22 18:26:35.633172	2025-06-23 18:26:35.633172	\N		2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
27	30	6	ขวด	8	8	dispensed	2025-06-18 18:26:35.633172	2025-06-19 18:26:35.633172	\N	ไม่ผ่านการตรวจสอบ	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
47	27	1	กล่อง	8	\N	dispensed	2025-08-18 15:11:42.925242	\N	\N		2025-08-18 15:11:42.925242	2025-08-18 15:11:42.925242	t	\N	\N
48	26	1	ขวด	8	\N	dispensed	2025-08-18 15:12:00.917464	\N	\N		2025-08-18 15:12:00.917464	2025-08-18 15:12:00.917464	t	\N	\N
49	22	6	กล่อง	8	\N	dispensed	2025-08-18 15:22:51.040005	\N	\N		2025-08-18 15:22:51.040005	2025-08-18 15:22:51.040005	t	\N	\N
50	28	7	กล่อง	8	\N	dispensed	2025-08-20 00:52:33.513617	\N	\N		2025-08-20 00:52:33.513617	2025-08-20 00:52:33.513617	t	\N	\N
51	26	1	ขวด	8	\N	dispensed	2025-08-20 00:55:40.765119	\N	\N		2025-08-20 00:55:40.765119	2025-08-20 00:55:40.765119	t	\N	\N
52	26	1	ขวด	8	\N	dispensed	2025-08-20 00:57:03.845968	\N	\N		2025-08-20 00:57:03.845968	2025-08-20 00:57:03.845968	t	\N	\N
53	26	1	ขวด	8	\N	dispensed	2025-08-20 00:57:08.929063	\N	\N		2025-08-20 00:57:08.929063	2025-08-20 00:57:08.929063	t	\N	\N
54	29	1	หลอด	8	\N	dispensed	2025-08-20 00:58:48.473579	\N	\N		2025-08-20 00:58:48.473579	2025-08-20 00:58:48.473579	t	\N	\N
29	22	15	เม็ด	8	8	dispensed	2025-06-23 18:26:35.633172	\N	\N	ด่วน	2025-06-23 18:26:35.633172	2025-06-23 18:26:35.633172	t	\N	\N
32	1	100	capsule	8	\N	dispensed	2025-08-10 11:58:26.485921	\N	\N		2025-08-10 11:58:26.485921	2025-08-10 11:58:26.485921	t	\N	\N
34	1	3	aaaa	8	\N	dispensed	2025-08-10 12:18:17.959122	\N	\N		2025-08-10 12:18:17.959122	2025-08-10 12:18:17.959122	t	\N	\N
35	2	10000000	amp	8	\N	dispensed	2025-08-10 12:19:34.554223	\N	\N		2025-08-10 12:19:34.554223	2025-08-10 12:19:34.554223	t	\N	\N
36	2	100000	amp	8	\N	dispensed	2025-08-10 12:19:50.88031	\N	\N		2025-08-10 12:19:50.88031	2025-08-10 12:19:50.88031	t	\N	\N
37	4	1	amp	8	\N	dispensed	2025-08-10 12:20:01.304631	\N	\N		2025-08-10 12:20:01.304631	2025-08-10 12:20:01.304631	t	\N	\N
38	1	1	n	8	\N	dispensed	2025-08-10 12:20:36.628982	\N	\N		2025-08-10 12:20:36.628982	2025-08-10 12:20:36.628982	t	\N	\N
39	1	50	ซอง	8	\N	dispensed	2025-08-16 14:42:17.420652	\N	\N		2025-08-16 14:42:17.420652	2025-08-16 14:42:17.420652	t	\N	\N
40	30	12	หลอด	8	\N	dispensed	2025-08-16 16:39:30.646814	\N	\N		2025-08-16 16:39:30.646814	2025-08-16 16:39:30.646814	t	\N	\N
41	30	1	หลอด	8	\N	dispensed	2025-08-16 18:03:49.810981	\N	\N		2025-08-16 18:03:49.810981	2025-08-16 18:03:49.810981	t	\N	\N
42	30	3	หลอด	8	\N	dispensed	2025-08-18 05:10:23.786701	\N	\N		2025-08-18 05:10:23.786701	2025-08-18 05:10:23.786701	t	\N	\N
43	30	50	หลอด	8	\N	dispensed	2025-08-18 13:01:05.441176	\N	\N		2025-08-18 13:01:05.441176	2025-08-18 13:01:05.441176	t	\N	\N
44	29	100	หลอด	8	\N	dispensed	2025-08-18 13:30:45.147231	\N	\N		2025-08-18 13:30:45.147231	2025-08-18 13:30:45.147231	t	\N	\N
45	27	3	กล่อง	8	\N	dispensed	2025-08-18 15:01:52.639994	\N	\N		2025-08-18 15:01:52.639994	2025-08-18 15:01:52.639994	t	\N	\N
46	27	5	กล่อง	8	\N	dispensed	2025-08-18 15:05:14.106614	\N	\N		2025-08-18 15:05:14.106614	2025-08-18 15:05:14.106614	t	\N	\N
55	27	1	กล่อง	8	\N	dispensed	2025-08-20 00:59:04.787905	\N	\N		2025-08-20 00:59:04.787905	2025-08-20 00:59:04.787905	t	\N	\N
56	25	3	หลอด	8	\N	dispensed	2025-08-20 00:59:15.844856	\N	\N		2025-08-20 00:59:15.844856	2025-08-20 00:59:15.844856	t	\N	\N
57	30	2	หลอด	8	\N	dispensed	2025-08-21 03:14:50.715782	\N	\N		2025-08-21 03:14:50.715782	2025-08-21 03:14:50.715782	t	\N	\N
64	30	2	หลอด	8	\N	dispensed	2025-08-21 08:41:01.391139	2025-08-17 23:50:11.513326	\N		2025-08-21 08:41:01.391139	2025-08-21 08:41:01.391139	t	subwareshouse	285
\.
...
COPY public.med_subwarehouse (med_sid, med_id, med_quantity, packaging_type, is_divisible, location, created_at, updated_at, med_showname, min_quantity, max_quantity, cost_price, unit_price, med_showname_eng, mfg_date, exp_date, is_expired) FROM stdin;
250	10	345	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-25 05:07:56.575874	อะทอร์วาสแตติน 20mg แผง 200 เม็ด	10	1000	4.00	8.00	Atorvastatin 20mg Box 200 Tablets	2023-05-17	2025-10-11	f
275	25	464	กล่อง	t	Cabinet C	2025-08-16 12:00:00	2025-08-25 05:19:09.381917	เมโทโพรลอล 50mg แผง 500 เม็ด	10	1000	3.20	6.40	\N	\N	\N	f
268	22	242	กล่อง	t	Cabinet C	2025-08-16 12:00:00	2025-08-25 12:30:12.201697	ลิซิโนพริล 10mg กล่อง 20 เม็ด	10	1000	2.00	4.00	\N	\N	\N	f
252	12	111	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เลโวไทรอกซีน 100mcg กล่อง 50 เม็ด	10	1000	2.00	4.00	Levothyroxine 100mcg Box 50 Tablets	2023-09-04	2025-09-26	f
232	2	48	ขวด	f	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไอบูโพรเฟน 400mg ขวด 1000 แคปซูล	10	1000	2.00	4.00	Ibuprofen 400mg Bottle 1000 Capsules	2023-03-07	2025-09-20	f
233	3	23	ขวด	f	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอม็อกซีซิลลิน 500mg ขวด 500 แคปซูล	10	1000	1.50	3.00	Amoxicillin 500mg Bottle 500 Capsules	2024-07-03	2025-10-22	f
255	13	274	หลอด	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ซิมวาสแตติน 20mg หลอด 20 เม็ด	10	1000	2.20	4.40	Simvastatin 20mg Tube 20 Tablets	2023-08-02	2025-09-19	f
281	28	440	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ซิทากลิพติน 50mg กล่อง 50 เม็ด	10	1000	15.00	30.00	Sitagliptin 50mg Box 50 Tablets	2024-04-27	2025-10-11	f
279	26	274	ขวด	f	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แทมซูโลซิน 0.4mg ขวด 1000 แคปซูล	10	1000	4.80	9.60	Tamsulosin 0.4mg Bottle 1000 Capsules	2024-07-07	2025-09-20	f
276	25	200	กล่อง	t	Drawer D4	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เมโทโพรลอล 50mg กล่อง 50 เม็ด	10	1000	3.30	6.60	Metoprolol 50mg Box 50 Tablets	2024-08-06	2025-09-23	f
265	21	256	ขวด	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	อัลโลพูรินอล 100mg ขวด 100 เม็ด	10	1000	1.50	3.00	Allopurinol 100mg Bottle 100 Tablets	2024-11-11	2025-09-28	f
260	17	482	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอมโลดิปีน 5mg กล่อง 50 เม็ด	10	1000	3.00	6.00	Amlodipine 5mg Box 50 Tablets	2025-08-03	2025-10-12	f
271	24	246	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไดจอกซิน 0.25mg กล่อง 50 เม็ด	10	1000	2.00	4.00	Digoxin 0.25mg Box 50 Tablets	2024-06-16	2025-09-17	f
280	27	353	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	มอนเทลูคาสท์ 10mg กล่อง 100 เม็ด	10	1000	10.00	20.00	Montelukast 10mg Box 100 Tablets	2024-03-11	2025-10-14	f
270	23	120	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	บิโซโปรลอล 5mg กล่อง 50 เม็ด	10	1000	3.00	6.00	\N	2024-02-21	2025-09-06	f
278	26	35	กล่อง	f	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แทมซูโลซิน 0.4mg กล่อง 100 แคปซูล	10	1000	5.20	10.40	\N	2024-05-29	2025-09-28	f
258	15	313	หลอด	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	อีนาลาพริล 10mg หลอด 20 เม็ด	10	1000	2.20	4.40	\N	2023-01-13	2025-09-19	f
261	17	344	กล่อง	t	Cabinet C	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอมโลดิปีน 5mg กล่อง 100 เม็ด	10	1000	2.80	5.60	Amlodipine 5mg Box 100 Tablets	2023-02-27	2025-10-08	f
262	18	154	ขวด	t	Drawer D4	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เดกซาเมทาโซน 0.5mg ขวด 1000 เม็ด	10	1000	1.00	2.00	Dexamethasone 0.5mg Bottle 1000 Tablets	2025-07-02	2025-10-20	f
266	21	193	ขวด	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	อัลโลพูรินอล 100mg ขวด 1000 เม็ด	10	1000	1.30	2.60	Allopurinol 100mg Bottle 1000 Tablets	2025-01-28	2025-10-03	f
267	21	477	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	อัลโลพูรินอล 100mg กล่อง 100 เม็ด	10	1000	1.50	3.00	Allopurinol 100mg Box 100 Tablets	2023-09-30	2025-09-24	f
285	30	2	หลอด	t	Cabinet C	2025-08-16 12:00:00	2025-08-24 18:29:21.154951	เซอร์ทราลีน 50mg หลอด 5 เม็ด	10	1000	5.50	11.00	Sertraline 50mg Tube 5 Tablets	2023-01-17	2025-10-16	f
284	29	4	หลอด	f	Shelf B2	2025-08-16 12:00:00	2025-08-25 05:07:56.575874	ฟลูออกซีทีน 20mg แผง 10 แคปซูล	10	1000	5.00	10.00	Fluoxetine 20mg Tube 20 Capsules	2023-11-23	2025-10-10	f
274	25	437	หลอด	t	Shelf B2	2025-08-16 12:00:00	2025-08-25 05:07:56.575874	เมโทโพรลอล 50mg แผง 5 เม็ด	10	1000	3.50	7.00	Metoprolol 50mg Tube 5 Tablets	2023-09-19	2025-09-30	f
277	26	231	ขวด	f	Shelf B2	2025-08-16 12:00:00	2025-08-25 05:07:56.575874	แทมซูโลซิน 0.4mg แผง 10 แคปซูล	10	1000	5.00	10.00	Tamsulosin 0.4mg Bottle 500 Capsules	2022-10-25	2025-09-28	f
283	29	274	กล่อง	f	Shelf B2	2025-08-16 12:00:00	2025-08-25 05:07:56.575874	ฟลูออกซีทีน 20mg แผง 20 แคปซูล	10	1000	5.20	10.40	Fluoxetine 20mg Tube 10 Capsules	2024-02-28	2025-09-04	f
256	14	186	ขวด	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไกลเบนคลาไมด์ 5mg ขวด 1000 เม็ด	10	1000	1.00	2.00	Glibenclamide 5mg Bottle 1000 Tablets	2023-05-19	2025-10-17	f
257	14	247	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไกลเบนคลาไมด์ 5mg กล่อง 200 เม็ด	10	1000	1.10	2.20	Glibenclamide 5mg Box 200 Tablets	2024-10-18	2025-10-13	f
253	13	255	หลอด	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ซิมวาสแตติน 20mg หลอด 20 เม็ด	10	1000	2.20	4.40	Simvastatin 20mg Tube 20 Tablets	2025-05-09	2025-10-05	f
254	13	140	ขวด	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ซิมวาสแตติน 20mg ขวด 100 เม็ด	10	1000	2.00	4.00	Simvastatin 20mg Bottle 100 Tablets	2022-12-19	2025-09-24	f
259	16	191	หลอด	t	Rack E	2025-08-16 12:00:00	2025-08-25 05:19:09.39018	ไนเฟดิปีน 30mg หลอด 10 เม็ด	10	1000	3.50	7.00	\N	\N	\N	f
230	1	111	ขวด	t	Rack E	2025-08-16 12:00:00	2025-08-25 05:19:09.525718	พาราเซตามอล 500mg ขวด 100 เม็ด	10	1000	0.45	0.90	\N	\N	\N	f
235	3	145	กล่อง	f	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอม็อกซีซิลลิน 500mg กล่อง 50 แคปซูล	10	1000	1.60	3.20	Amoxicillin 500mg Box 50 Capsules	2025-01-14	2025-09-09	f
231	1	45	หลอด	t	Shelf A1	2025-08-16 12:00:00	2025-08-25 12:30:12.232043	พาราเซตามอล 500mg หลอด 5 เม็ด	10	1000	0.60	1.20	\N	\N	\N	f
229	1	13	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-25 12:30:47.439854	พาราเซตามอล 500mg กล่อง 200 เม็ด	10	1000	0.50	1.00	\N	\N	\N	f
234	3	214	หลอด	f	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอม็อกซีซิลลิน 500mg หลอด 5 แคปซูล	10	1000	1.80	3.60	Amoxicillin 500mg Tube 5 Capsules	2024-08-24	2025-09-10	f
245	8	317	กล่อง	f	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โอเมพราโซล 20mg กล่อง 50 แคปซูล	10	1000	4.00	8.00	Omeprazole 20mg Box 50 Capsules	2024-11-27	2025-10-14	f
242	6	101	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เมตฟอร์มิน 500mg กล่อง 50 เม็ด	10	1000	1.10	2.20	Metformin 500mg Box 50 Tablets	2025-04-30	2025-09-05	f
244	7	430	หลอด	t	Cabinet C	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โลซาร์แทน 50mg หลอด 10 เม็ด	10	1000	3.50	7.00	Losartan 50mg Tube 10 Tablets	2025-05-20	2025-10-04	f
247	9	465	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โคลปิโดเกรล 75mg กล่อง 50 เม็ด	10	1000	5.00	10.00	Clopidogrel 75mg Box 50 Tablets	2023-06-05	2025-09-30	f
246	8	187	ขวด	f	Cabinet C	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โอเมพราโซล 20mg ขวด 100 แคปซูล	10	1000	3.80	7.60	Omeprazole 20mg Bottle 100 Capsules	2023-08-05	2025-10-26	f
251	11	397	หลอด	t	Cabinet C	2025-08-16 12:00:00	2025-08-25 12:30:47.433725	ไฮโดรคลอโรไทอาไซด์ 25mg หลอด 20 เม็ด	10	1000	1.00	2.00	\N	\N	\N	f
243	6	324	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เมตฟอร์มิน 500mg กล่อง 200 เม็ด	10	1000	1.00	2.00	Metformin 500mg Box 200 Tablets	2025-05-21	2025-09-18	f
248	9	317	ขวด	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โคลปิโดเกรล 75mg ขวด 100 เม็ด	10	1000	4.80	9.60	Clopidogrel 75mg Bottle 100 Tablets	2024-12-20	2025-10-20	f
236	4	215	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอสไพริน 325mg กล่อง 50 เม็ด	10	1000	0.80	1.60	Aspirin 325mg Box 50 Tablets	2023-08-15	2025-10-11	f
237	4	107	กล่อง	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แอสไพริน 325mg กล่อง 200 เม็ด	10	1000	0.70	1.40	\N	2023-05-23	2025-10-18	f
238	4	5	กล่อง	t	Cabinet C	2025-08-16 12:00:00	2025-08-25 19:20:52.977227	แอสไพริน 325mg กล่อง 50 เม็ด	10	1000	0.80	1.60	\N	2023-03-01	2025-10-20	f
239	5	306	กล่อง	t	Drawer D4	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เซทิริซีน 10mg กล่อง 200 เม็ด	10	1000	1.00	2.00	Cetirizine 10mg Box 200 Tablets	2022-11-09	2025-10-11	f
240	5	273	หลอด	t	Shelf A1	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เซทิริซีน 10mg หลอด 20 เม็ด	10	1000	1.20	2.40	Cetirizine 10mg Tube 20 Tablets	2023-03-13	2025-09-21	f
241	6	154	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	เมตฟอร์มิน 500mg กล่อง 200 เม็ด	10	1000	1.00	2.00	Metformin 500mg Box 200 Tablets	2023-05-05	2025-09-08	f
249	9	237	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	โคลปิโดเกรล 75mg กล่อง 50 เม็ด	10	1000	5.00	10.00	Clopidogrel 75mg Box 50 Tablets	2023-07-27	2025-09-06	f
273	24	472	ขวด	t	Cabinet C	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไดจอกซิน 0.25mg ขวด 100 เม็ด	10	1000	1.90	3.80	Digoxin 0.25mg Bottle 100 Tablets	2022-10-11	2025-10-01	f
282	29	119	หลอด	f	Shelf B2	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ฟลูออกซีทีน 20mg หลอด 20 แคปซูล	10	1000	5.00	10.00	Fluoxetine 20mg Tube 20 Capsules	2024-01-24	2025-09-08	f
264	20	256	กล่อง	t	Cabinet C	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	แรนิทิดีน 150mg กล่อง 50 เม็ด	10	1000	2.00	4.00	Ranitidine 150mg Box 50 Tablets	2023-02-16	2025-09-17	f
272	24	381	ขวด	t	Drawer D4	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	ไดจอกซิน 0.25mg ขวด 500 เม็ด	10	1000	1.80	3.60	Digoxin 0.25mg Bottle 500 Tablets	2023-05-14	2025-10-11	f
263	19	475	กล่อง	t	Rack E	2025-08-16 12:00:00	2025-08-23 12:57:10.192148	สไปโรโนแลคโตน 25mg กล่อง 100 เม็ด	10	1000	2.00	4.00	Spironolactone 25mg Box 100 Tablets	2024-07-03	2025-10-16	f
269	22	436	กล่อง	t	Shelf B2	2025-08-16 12:00:00	2025-08-25 19:15:55.074463	ลิซิโนพริล 10mg กล่อง 100 เม็ด	10	1000	2.00	4.00	Lisinopril 10mg Box 100 Tablets	2024-06-30	2025-08-04	t
\.
...
1	Paracetamol	Acetaminophen	Mild	Tablet	ParaMax	พาราเซตามอล	1.5	2	1.75	Oral	Analgesic	Y	f	\N	TMT001	TP001	Take 1 tablet every 6 hours	T001	TPU001	A	f	5	2025-03-01	2027-03-01
...
COPY public.noti_rules (rule_id, rule_name, rule_type, related_table, trigger_condition, template_title, template_message, recipient_role_id, check_frequency, is_active, last_checked_at) FROM stdin;
2	Expiring Soon Alert	exp_date_warning	{"main_table": "med_subwarehouse"}	{"field": "exp_date", "value": "now()::date + interval '7 days'", "operator": "<="}	แจ้งเตือน: ยาใกล้หมดอายุ	ยา [med_showname] (รหัส [med_sid]) จะหมดอายุในวันที่ [exp_date] โปรดดำเนินการ	101	1440	t	2025-08-25 22:46:00.033384
1	Low Stock Alert	stock_alert	{"main_table": "med_subwarehouse"}	{"field": "med_quantity", "value": 10, "operator": "<="}	แจ้งเตือน: สินค้าใกล้หมดสต็อก	ยา [med_showname] (รหัส [med_sid]) เหลือเพียง [med_quantity] ชิ้น โปรดทำการสั่งซื้อเพิ่ม	101	60	t	2025-08-25 22:46:00.039682
3	New Order Request	new_request	{"main_table": "med_requests", "join_tables": {"users": {"on": {"join_table_column": "uid", "main_table_column": "requested_by"}, "table": "users"}, "med_table": {"on": {"join_table_column": "med_id", "main_table_column": "med_id"}, "table": "med_table"}}}	{"field": "status", "value": "pending", "operator": "="}	แจ้งเตือน: มีรายการเบิกยาใหม่	มีรายการเบิกยาใหม่จากผู้ใช้งาน [username] จำนวน [quantity] [unit] ของยา [med_name] (รหัส [med_id])	101	10	t	2025-08-25 22:46:00.043522
9	Expired Medicine Alert	expiry_alert	{"main_table": "med_subwarehouse"}	{"field": "exp_date", "value": "now()::date + interval '1 days'", "operator": "<="}	แจ้งเตือน: ยาหมดอายุ	ยา [med_showname] (รหัส [med_sid]) กำลังจะหมดอายุในวันที่ [exp_date] กรุณาตรวจสอบและดำเนินการ	101	86400	t	2025-08-25 22:46:00.047117
4	Overdue Dispense Alert	overdue_alert	{"main_table": "overdue_med", "join_tables": {"patient": {"on": {"join_table_column": "patient_id", "main_table_column": "patient_id"}, "table": "patient"}, "med_table": {"on": {"join_table_column": "med_id", "main_table_column": "med_id"}, "table": "med_table"}}}	{"field": "dispense_status", "value": false, "operator": "="}	แจ้งเตือน: ยาค้างจ่าย	มีรายการยาของ [first_name] [last_name] ค้างจ่ายในวันที่ [time] (รหัสค้างจ่าย [overdue_id])	101	60	t	2025-08-25 22:46:00.055709
7	Error Medication Report	error_report_alert	{"main_table": "error_medication", "join_tables": {"patient": {"on": {"join_table_column": "patient_id", "main_table_column": "patient_id"}, "table": "patient"}, "med_table": {"on": {"join_table_column": "med_id", "main_table_column": "med_id"}, "table": "med_table"}}}	{"field": "created_at", "value": "now()::date", "operator": ">="}	แจ้งเตือน: มีการรายงาน Error Medication ใหม่	มีการรายงานข้อผิดพลาดทางการจ่ายยาใหม่สำหรับผู้ป่วย [patient_id]	101	1440	t	2025-08-25 22:46:00.051335
5	Cut-off Period Approaching	cut_off_alert	{"main_table": "med_cut_off_period", "join_tables": {"sub_warehouse": {"on": {"join_table_column": "sub_warehouse_id", "main_table_column": "sub_warehouse_id"}, "table": "sub_warehouse"}}}	{"field": "updated_at", "value": "now()::date + interval '7 days'", "operator": "<"}	แจ้งเตือน: ถึงรอบตัดยอดการเบิกจ่ายยา	กำลังจะถึงรอบตัดยอดเบิกจ่ายยาสำหรับคลัง [name] วันที่ [period_day] เดือน [period_month]	101	1440	t	2025-08-25 22:46:00.060794
6	ADR Report	adr_report_alert	{"main_table": "adr_registry", "join_tables": {"patient": {"on": {"join_table_column": "patient_id", "main_table_column": "patient_id"}, "table": "patient"}, "med_table": {"on": {"join_table_column": "med_id", "main_table_column": "med_id"}, "table": "med_table"}}}	{"field": "reported_at", "value": "now()::date", "operator": ">="}	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย [first_name] [last_name] สำหรับยา [med_name]	101	1440	t	2025-08-25 22:46:00.073366
\.
...
COPY public.notification_log (log_id, rule_id, related_table, related_id, sent_at) FROM stdin;
1	1	med_subwarehouse	285	2025-08-25 22:28:10.030425
2	1	med_subwarehouse	284	2025-08-25 22:28:10.037289
3	1	med_subwarehouse	238	2025-08-25 22:28:10.042777
4	3	med_requests	68	2025-08-25 22:28:10.052024
5	9	med_subwarehouse	269	2025-08-25 22:28:10.060342
6	2	med_subwarehouse	269	2025-08-25 22:28:10.0681
7	7	error_medication	18	2025-08-25 22:28:10.075329
8	4	overdue_med	33	2025-08-25 22:28:10.08479
9	5	med_cut_off_period	21	2025-08-25 22:28:10.092561
10	5	med_cut_off_period	16	2025-08-25 22:28:10.098215
11	6	adr_registry	1	2025-08-25 22:28:10.107334
12	6	adr_registry	2	2025-08-25 22:28:10.114039
13	6	adr_registry	3	2025-08-25 22:28:10.119262
14	6	adr_registry	4	2025-08-25 22:28:10.124413
15	6	adr_registry	5	2025-08-25 22:28:10.129738
16	6	adr_registry	6	2025-08-25 22:28:10.13466
17	6	adr_registry	7	2025-08-25 22:28:10.139227
18	6	adr_registry	8	2025-08-25 22:28:10.144656
19	6	adr_registry	9	2025-08-25 22:28:10.149434
20	6	adr_registry	10	2025-08-25 22:28:10.153937
\.
...
COPY public.notifications (notification_id, user_id, title, message, type, related_table, related_id, is_read, created_at, updated_at) FROM stdin;
1	8	แจ้งเตือน: สินค้าใกล้หมดสต็อก	ยา เซอร์ทราลีน 50mg หลอด 5 เม็ด (รหัส 285) เหลือเพียง 2 ชิ้น โปรดทำการสั่งซื้อเพิ่ม	\N	med_subwarehouse	285	f	2025-08-25 22:28:10.025453	\N
2	8	แจ้งเตือน: สินค้าใกล้หมดสต็อก	ยา ฟลูออกซีทีน 20mg แผง 10 แคปซูล (รหัส 284) เหลือเพียง 4 ชิ้น โปรดทำการสั่งซื้อเพิ่ม	\N	med_subwarehouse	284	f	2025-08-25 22:28:10.035022	\N
3	8	แจ้งเตือน: สินค้าใกล้หมดสต็อก	ยา แอสไพริน 325mg กล่อง 50 เม็ด (รหัส 238) เหลือเพียง 5 ชิ้น โปรดทำการสั่งซื้อเพิ่ม	\N	med_subwarehouse	238	f	2025-08-25 22:28:10.040524	\N
4	8	แจ้งเตือน: มีรายการเบิกยาใหม่	มีรายการเบิกยาใหม่จากผู้ใช้งาน น.พ จิรวัฒน์ เจนจบธรรม จำนวน 1 หลอด ของยา Fluoxetine (รหัส 29)	\N	med_requests	68	f	2025-08-25 22:28:10.050138	\N
5	8	แจ้งเตือน: ยาหมดอายุ	ยา ลิซิโนพริล 10mg กล่อง 100 เม็ด (รหัส 269) กำลังจะหมดอายุในวันที่ 4/8/2568 กรุณาตรวจสอบและดำเนินการ	\N	med_subwarehouse	269	f	2025-08-25 22:28:10.057765	\N
6	8	แจ้งเตือน: ยาใกล้หมดอายุ	ยา ลิซิโนพริล 10mg กล่อง 100 เม็ด (รหัส 269) จะหมดอายุในวันที่ 4/8/2568 โปรดดำเนินการ	\N	med_subwarehouse	269	f	2025-08-25 22:28:10.066221	\N
7	8	แจ้งเตือน: มีการรายงาน Error Medication ใหม่	มีการรายงานข้อผิดพลาดทางการจ่ายยาใหม่สำหรับผู้ป่วย 4	\N	error_medication	18	f	2025-08-25 22:28:10.07309	\N
8	8	แจ้งเตือน: ยาค้างจ่าย	มีรายการยาของ สมชาย ใจดี ค้างจ่ายในวันที่ 24/8/2568 (รหัสค้างจ่าย 33)	\N	overdue_med	33	f	2025-08-25 22:28:10.082306	\N
9	8	แจ้งเตือน: ถึงรอบตัดยอดการเบิกจ่ายยา	กำลังจะถึงรอบตัดยอดเบิกจ่ายยาสำหรับคลัง ห้องจ่ายยา IPD วันที่ 21 เดือน 8	\N	med_cut_off_period	21	f	2025-08-25 22:28:10.09036	\N
10	8	แจ้งเตือน: ถึงรอบตัดยอดการเบิกจ่ายยา	กำลังจะถึงรอบตัดยอดเบิกจ่ายยาสำหรับคลัง ห้องจ่ายยา OPD วันที่ 10 เดือน 6	\N	med_cut_off_period	16	f	2025-08-25 22:28:10.096355	\N
11	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย สมชาย ใจดี สำหรับยา Enalapril	\N	adr_registry	1	f	2025-08-25 22:28:10.105396	\N
12	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย สมหญิง สวยงาม สำหรับยา Lisinopril	\N	adr_registry	2	f	2025-08-25 22:28:10.111749	\N
13	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย วิชัย ทองดี สำหรับยา Cetirizine	\N	adr_registry	3	f	2025-08-25 22:28:10.11691	\N
14	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย อรทัย บุญมาก สำหรับยา Atorvastatin	\N	adr_registry	4	f	2025-08-25 22:28:10.122065	\N
15	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย ปกรณ์ รุ่งเรือง สำหรับยา Amoxicillin	\N	adr_registry	5	f	2025-08-25 22:28:10.127795	\N
16	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย ชลธิชา สมสุข สำหรับยา Dexamethasone	\N	adr_registry	6	f	2025-08-25 22:28:10.132882	\N
17	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย ดำรง มั่นคง สำหรับยา Ibuprofen	\N	adr_registry	7	f	2025-08-25 22:28:10.137449	\N
18	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย ศิริพร ไพศาล สำหรับยา Metoprolol	\N	adr_registry	8	f	2025-08-25 22:28:10.142266	\N
19	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย เกรียงไกร เกษมสุข สำหรับยา Omeprazole	\N	adr_registry	9	f	2025-08-25 22:28:10.147446	\N
20	8	แจ้งเตือน: มีการรายงาน ADR ใหม่	มีการรายงานอาการไม่พึงประสงค์ (ADR) ใหม่จากผู้ป่วย วราภรณ์ เพียรดี สำหรับยา Levothyroxine	\N	adr_registry	10	f	2025-08-25 22:28:10.152035	\N
\.
...
COPY public.overdue_med (overdue_id, med_id, dispense_status, patient_id, med_sid, "time", doctor_id, quantity) FROM stdin;
33	30	f	1	285	2025-08-24 18:31:23.819965	8	1
...
COPY public.rad_registry (rad_id, med_id, patient_id, description, acceptance, acceptance_time, specimen, pathogenic, indications, indications_criteria, submission_time, accept_by) FROM stdin;
2	8	12	ขอใช้ยาต้านไวรัสตับอักเสบซี	f	2025-04-20 11:05:00	น้ำลาย	Hepatitis C Virus	ตับอักเสบ C	anti-HCV positive	2025-04-20 11:05:00	10
4	10	7	ขอใช้ยาในภาวะติดเชื้อ CRE ใน ICU	f	2025-04-21 13:40:00	น้ำไขสันหลัง	Klebsiella pneumoniae (CRE)	เชื้อดื้อยาใน ICU	carbapenem-resistant positive	2025-04-21 13:40:00	10
5	1	9	ขอใช้ยาควบคุมรักษาวัณโรค	f	2025-04-24 08:15:00	เสมหะ	Mycobacterium tuberculosis	วัณโรคปอด	ผล smear positive	2025-04-24 08:15:00	10
6	6	14	ขอใช้ยาต้านมาลาเรีย	f	2025-04-18 16:20:00	น้ำลาย	Plasmodium falciparum	ไข้มาลาเรีย	malaria smear positive	2025-04-18 16:20:00	10
7	4	2	ขอใช้ยาในผู้ป่วยเยื่อหุ้มสมองอักเสบ	f	2025-04-23 10:45:00	น้ำไขสันหลัง	Neisseria meningitidis	เยื่อหุ้มสมองอักเสบ	culture positive	2025-04-23 10:45:00	10
8	3	6	ขอใช้ยาต้านไวรัส HIV	f	2025-04-17 12:00:00	เลือด	HIV	HIV infection	ผล anti-HIV positive	2025-04-17 12:00:00	10
9	7	1	ขอใช้ยาควบคุมเชื้อราในช่องปาก	f	2025-04-20 15:30:00	เสมหะ	Candida spp.	เชื้อราในช่องปาก	oral swab positive	2025-04-20 15:30:00	10
...
COPY public.roles (role_id, role_name, role_name_th, role_name_en) FROM stdin;
...
COPY public.users (uid, username, password, email, phone, role_id) FROM stdin;
...
SELECT pg_catalog.setval('public.adr_registry_adr_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.allergy_registry_allr_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.error_medication_err_med_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.expired_medicines_expired_med_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.med_cut_off_period_med_period_id_seq', 21, true);
...
SELECT pg_catalog.setval('public.med_delivery_delivery_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.med_order_history_history_id_seq', 93, true);
...
SELECT pg_catalog.setval('public.med_requests_request_id_seq', 70, true);
...
SELECT pg_catalog.setval('public.med_stock_history_history_id_seq', 193, true);
...
SELECT pg_catalog.setval('public.med_subwarehouse_med_sid_seq', 298, true);
...
SELECT pg_catalog.setval('public.med_usage_usage_id_seq', 273, true);
...
SELECT pg_catalog.setval('public.noti_rules_rule_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.notification_log_log_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.overdue_med_overdue_id_seq', 33, true);
...
ALTER TABLE ONLY public.expired_medicines
...
ALTER TABLE ONLY public.med_subwarehouse
...
ALTER TABLE ONLY public.noti_rules
...
CREATE INDEX fki_role_fk ON public.users USING btree (role_id);
...
CREATE TRIGGER update_med_subwarehouse_updated_at BEFORE UPDATE ON public.med_subwarehouse FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
...
ALTER TABLE ONLY public.error_medication
    ADD CONSTRAINT fk_error_medication FOREIGN KEY (med_sid) REFERENCES public.med_subwarehouse(med_sid) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.med_requests
    ADD CONSTRAINT fk_med_subwarehouse FOREIGN KEY (med_sid) REFERENCES public.med_subwarehouse(med_sid) ON DELETE SET NULL;
...
ALTER TABLE ONLY public.notifications
    ADD CONSTRAINT fk_notifications_user FOREIGN KEY (user_id) REFERENCES public.users(uid) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY public.med_requests
    ADD CONSTRAINT med_requests_request_id_fkey FOREIGN KEY (med_id) REFERENCES public.med_table(med_id);
...
ALTER TABLE ONLY public.med_subwarehouse
    ADD CONSTRAINT med_subwarehouse_med_id_fkey FOREIGN KEY (med_id) REFERENCES public.med_table(med_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.users
    ADD CONSTRAINT role_fk FOREIGN KEY (role_id) REFERENCES public.roles(role_id) NOT VALID;
